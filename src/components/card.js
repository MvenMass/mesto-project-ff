...
// const handleLikeClick = async (likeButton, cardId, likeCounter) => {
//   try {
//     const isActive = likeButton.classList.contains("card__like-button_is-active");
//     const updatedCard = await (isActive ? unlikeCard(cardId) : likeCard(cardId));
...
// const createCardElement = (data, userId, handleImageClick, handleLikeClick, handleDeleteClick) => {
...
//   likeButton.addEventListener("click", (evt) => handleLikeClick(evt, _id, likeCounter));
...
// const createCard = (data, handleImageClick, handleLikeClick, handleDeleteClick, userId) => {
//   return createCardElement(data, userId, handleImageClick, handleLikeClick, handleDeleteClick);
// };
